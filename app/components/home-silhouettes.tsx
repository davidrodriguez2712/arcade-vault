// Siluetas pixel decorativas de formas arcade clásicas. Portado de
// references/templates/home-about/home.jsx (FloatingSilhouettes).
export default function HomeSilhouettes() {
  return (
