// Iconos pixel 16x16 dibujados con rects, glow según el color del padre.
// Portado de references/templates/home-about/about.jsx (HighlightIcon).
export type HighlightIconKind = "HEART" | "BROWSER" | "PLANT";

export default function AboutHighlightIcon({ kind }: { kind: HighlightIconKind }) {
