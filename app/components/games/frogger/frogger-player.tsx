...
import { FroggerGame, type GameOverResult, type TouchAction } from "./engine";
...
export default function FroggerPlayer({ title }: FroggerPlayerProps) {
  ...
  useEffect(() => {
    ...
    const game = new FroggerGame(canvas);
  ...
  return (
    <div className="av-player av-player--game fade-in">
      <div className="game-topbar">
        <Link className="btn ghost" href="/juego/ranaria">
          VOLVER
        </Link>
        <SkinPicker
          gameId={GAME_ID}
      ...
      <div className="crt">
        <div className="crt-screen">
          <div className="frogger-stage" ref={stageRef}>
            <canvas
              ref={canvasRef}
        ...
        <div className="modal-bd">
          <div className="modal">
            ...
            <div className="actions">
              ...
              <Link className="btn magenta" href="/juego/ranaria">
                VOLVER
              </Link>
            </div>
          </div>
