import { GAMES, type GameColor } from "./games";
...
// STATS: 3 bloques derivados de los mocks. Sin Math.random ni Date.now.
export const HOME_STATS: StatBlock[] = [
  { n: String(GAMES.length), u: "JUEGOS", s: "EN LA BÓVEDA" },
  { n: totalPlays.toLocaleString("es-ES"), u: "PARTIDAS", s: "JUGADAS EN TOTAL" },
  { n: String(PLAYERS.length), u: "JUGADORES", s: "COMPITEN POR EL TOP" },
];

// TICKER: 7 filas. Fila top de cada uno de los primeros 7 juegos.
